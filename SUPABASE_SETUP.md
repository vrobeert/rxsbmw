# Supabase setup - BavarianHub

Ruleaza scriptul de mai jos in Supabase SQL Editor. Include tabelele fazei 1 si structura pentru faza 2.
...
Nu exista seed demo in aplicatie. Creeaza datele reale direct din Supabase sau din panoul admin al aplicatiei.

Daca ai rulat accidental seed-ul demo vechi, ruleaza `SUPABASE_DELETE_DEMO_DATA.sql` in Supabase SQL Editor.
